...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    ballet_special2_.LoadFromAMC(Platform::FindFile("05_08.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special2_.TrimBack(440);
    ballet_special2_.CalcRelativeTranslations();

    ballet_special3_.LoadFromAMC(Platform::FindFile("05_10.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special3_.TrimBack(160);
