...
public class Candidate implements Comparable<Candidate>{
     ...
     * @param test If this is being run as a test
     * @return If this candidate has more votes than other
     */
    public boolean isGreaterThan(Candidate other, boolean test) {
        //check for tie
        ...
        return numOfVotes > other.numOfVotes;
